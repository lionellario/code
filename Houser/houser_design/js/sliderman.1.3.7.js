...
var Sliderman = new function(){
	...
	function setStyle(style, property, value){
		...
		else if(property == 'clip') style[property] = 'rect('+Math.round(value[0])+'%, '+Math.round(value[1])+'%, '+Math.round(value[2])+'%, '+Math.round(value[3])+'%)';
		else if(property == 'opacity') setOpacity(style, value);
		else style[property] = Math.round(value)+'%';
	}//setStyle
