...
/**
 * @author Lionel Lario
 * Big O notation is a way to measure how well a computer algorithm scales as the amount of data
 * involved increases. It is not always a measure of speed as you'll see below
 * This is a rough overview of Big O and doesn't cover topics such as asymptotic analysis, which
 * covers comparing algorithms as data approaches infinity
...
public class BigONotation {
	...
	// O (log N) time it takes to complete the algorithm is
	// proportional to the logarithm of the input size.
	// Occurs when the data being used is decreased
...
public static void main(String[] args) {
		 ...
		 *
		 * System.out.println(Arrays.toString(testAlgo.arr));
		 */
