...
<title>::Gallery::..Houser.com</title>
...
<link rel="stylesheet" type="text/css" href="design/css/gallery_css.css"  />
<link rel="stylesheet" href="design/css/script_house_description.css" />
...
<body >
	<div id="main">
       <div id="header" style="height: 120px;"><center>
        ...
        <div id="mainContent">
            <div id="Qoption" >
                <?php
					include("Gallery.pages/option.php");
				?>
