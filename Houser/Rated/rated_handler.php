<?php
	...
	class Rated
	{
		function getMostViewHouses( $host, $user, $pass, $db)
		{
			...
			{
				if( $row['view'] >= 100 )
					include("file/getMostViewHouses.ini.php");
			...
			while( $row =  mysql_fetch_array($quer) )
			{
				if( $row['attribut'] == "new" )
				{
					echo '<div id="announce">';
						...
						echo '<img width="235" height="145" style="padding-top:8px;" '.
						'src="../Gallery/images/'.$row['image'].'" />';
						echo '</a>';
